...
% If size of the collage needs to be same as the original image
img2 = imresize(img,0.5);
red_image2 = imresize(red_image,0.5);
green_image2 = imresize(green_image,0.5);
blue_image2 = imresize(blue_image,0.5);

collage2_2x2 = [img2, red_image2;green_image2, blue_image2];
imshow(collage2_2x2);
c2=size(collage2_2x2);
